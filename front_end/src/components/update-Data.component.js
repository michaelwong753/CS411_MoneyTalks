          ...
          {this.state.submitted ? (
            ...
            <div>
              <div className="form-group">
                <label htmlFor="name">Date (REQURIRED!)</label>
                <input
                  type="text"
              ...
              <div className="form-group">
                <label htmlFor="description">Ticker (REQUIRED!)</label>
                <input
                  type="text"
                  className="form-control"
                  required
              ...
              <button onClick={this.updateData} className="btn btn-warning">
                Update
              </button>
              <div class="divider"/>
            </div>
